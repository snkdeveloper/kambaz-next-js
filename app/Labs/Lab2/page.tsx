import "./index.css";
import ForegroundColors from "./ForefroundColors";
...
import BootstrtrapNavigation from "./BootstrapNavigation";
export default function Lab2() {
  return (
    <Container>
      <h1 style={{ color: 'red', textAlign: 'center' }}>Sachet Kanchugar &apos; Assignment 2</h1>
